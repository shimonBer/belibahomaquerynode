...
async function generateReport(startDate, filename) {
    ...
    // await zipDirectory("/reports/quartelyKivunFiles", "quartelyKivunFiles.zip")
}

module.exports = generateReport

// main("2021-07", "2021-09").then(() => console.log())
